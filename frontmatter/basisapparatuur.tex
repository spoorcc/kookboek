...
\tip{Geen pastamachine, deegroller of staafmixer bij de hand? De meeste van
deze apparaten zijn te vervangen: een deegroller in plaats van een
pastamachine, een scherp mes in plaats van een mandoline. Bij gekookte
aardappelpuree werkt een staafmixer juist averechts, die maakt de puree
plakkerig in plaats van luchtig, gebruik dan een pureeknijper.}
\begin{ingredients}
\ingbnote{Blender}{, voor bevroren fruit tot ijs draaien}
\ingbnote{Keukenmachine}{, voor deeg kneden of iets fijnmalen}
\ingbnote{Pastamachine}{, optioneel, een deegroller kan ook}
\ingbnote{Staafmixer}{, voor het pureren van soep}
