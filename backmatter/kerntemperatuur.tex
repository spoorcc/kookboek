...
Vis & \hfill 63\,°C & \hfill — & \hfill — \\
\end{longtable}}

\vspace{0.2em}
{\footnotesize\itshape\color{inkfaint}Gebaseerd op Amerikaanse
vleeskeuringsrichtlijnen\cite{usda-fsis-appendixa,fda-foodcode}; vis heeft
in die richtlijnen maar één vaste waarde, geen aflopende reeks zoals
vlees.\par}
