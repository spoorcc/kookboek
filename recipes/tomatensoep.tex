...
\begin{steps}
  ...
  \item Schenk de olijfolie in een ovenschaal. Schep de tomaten, uienringen en
        ...
        basilicum-takjes toe in de laatste paar minuten.
  ...
  \item Warm de soep op en schep in verwarmde kommen. Druppel wat olijfolie en en leg er wat basilicumblaadjes over.
\end{steps}
\end{recipe}
