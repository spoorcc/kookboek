...
\meta{1{,}5 uur \dvd Voor 4--6 porties}
...
rauw blijft. Snij ze dun en sla het blancheren niet over.
...
\begin{ingredients}
  ...
  \ing{150--200 g}{zachte geitenkaas}\index[register]{Geitenkaas}
  \ing{1 flinke lepel}{Griekse yoghurt}
  \ing{2}{eieren}
  \ingb{verse tijm}
  \ingb{knoflookpoeder, uienpoeder, peper, zout}
\end{ingredients}
...
\begin{steps}
  ...
  \item Meng de geitenkaas, Griekse yoghurt en eieren tot een egaal mengsel. Breng
        ...
        kloppen.
  \item Verwarm de oven voor op 180\,°C. Vet de springvorm in, strooi er een beetje
        bloem in en klop de vorm rond zodat de bloem de bodem en wanden bedekt.
  \item Rol het deeg uit en bekleed de springvorm. Leg de groenteplakken van de
