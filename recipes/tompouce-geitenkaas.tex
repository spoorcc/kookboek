...
\marginimage{images/tompouce-geitenkaas-ingredienten}
...
\begin{steps}
  ...
  \item Doe de mousse in de garneerspuit en laat opstijven
    in de koelkast.
...
\end{steps}
\heroimage{images/tompouce-geitenkaas-hero}{Hartige tompouce met geitenkaasmousse, prosciutto en rucola.}
\end{recipe}
