...
\meta{30 minuten \dvd Voor 4 personen \dvd Oven 225\,°C}
...
\begin{ingredients}
  \ing{4 plakjes}{bladerdeeg}
  \ing{1}{ei}
  \ing{75 gr}{zachte geitenkaas}
  \ing{100 ml}{slagroom}
  \ing{80 gr}{prosciutto}
  \ing{40 gr}{rucola}
  \ing{40 gr}{zongedroogde tomaatjes}
  \ing{20 gr}{maanzaad}
  \ingb{balsamicocrema}
...
\begin{steps}
  ...
  \item Halveer de plakjes bladerdeeg en leg ze op een met bakpapier beklede
    bakplaat. Prik elk plakje een aantal keer in met een vork, dat voorkomt dat het deeg te
    veel opbolt. Bestrijk ze met
    losgeklopt ei. Verdeel het maanzaad over de helft van de plakjes: dit worden
    de bovenkantjes. Bak alles in 10--12 minuten goudbruin en laat afkoelen.
  \item Roer de geitenkaas glad met een spatel. Klop in een aparte kom de
    slagroom stijf. Spatel de slagroom voorzichtig door de geitenkaas en breng
    op smaak met zwarte peper. Doe de mousse in een spuitzak en laat opstijven
    in de koelkast.
  \item Spuit de geitenkaasmousse in een zigzagbeweging op de plakjes bladerdeeg
    zonder maanzaad. Leg per tompouce 2 plakjes prosciutto op de mousse en
