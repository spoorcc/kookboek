...
\meta{Ca. 15 uur (incl. nacht) \dvd 2 broden \dvd Oven 230\,°C}

\lettrine{C}{iabatta} dankt zijn kenmerkende grote gaten aan twee dingen: een
poolish die een nacht staat te rijpen, en een nat deeg met een hydratatie van
bijna 78\%. Het actieve werk is beperkt, maar reken op geduld: het deeg moet
overnacht en de volgende dag nog een paar uur rijzen.

\blockrule{Ingrediënten}

\noindent\textit{Poolish (voordeeg, avond van tevoren)}
\begin{ingredients}
  \ing{150 g}{tarwebloem (hoog eiwitgehalte, type T55 of T65)}\index[register]{Bloem}
  \ing{150 ml}{water}
...
\begin{ingredients}
  \ing{300 g}{tarwebloem (hoog eiwitgehalte, type T55 of T65)}
  \ing{200 ml}{water}
...
\begin{steps}
  \item Meng de bloem, het water en de gist tot een dun beslag. Dek af en laat
        12 tot 16 uur op kamertemperatuur staan, tot het mengsel bubbels
        vertoont en naar gist ruikt.
\end{steps}
...
\begin{steps}
  \item Stort het deeg voorzichtig op een flink bebloemd werkvlak. Snijd het
        in twee stukken en leg ze op bakpapier, zonder verder te kneden of te
        drukken.
  \item Dek af met een doek en laat 30 minuten rijzen. Verwarm ondertussen de
        oven minstens 30 minuten voor op 230\,°C, het liefst met een
        bakplaat of pizzasteen mee-opwarmend.
  \item Schuif het brood de oven in en voeg stoom toe, bijvoorbeeld met een
        schaaltje water onderin de oven. Bak 22 tot 27 minuten.
  \item Haal na de eerste 10 minuten het schaaltje water uit de oven, zodat de
        korst knapperig wordt.
  \item Laat de ciabatta's afkoelen op een rooster voordat je ze aansnijdt.
\end{steps}
\end{recipe}
