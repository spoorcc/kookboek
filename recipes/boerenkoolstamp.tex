...
\lettrine{B}{oerenkoolstamp} met rookworst is dezelfde stamp als de
andijviestamp, maar dan zonder kerrie en spekjes en met een Gelderse
rookworst erbij.
...
\begin{steps}
  ...
  \item Breng op smaak met peper en zout. Serveer met de rookworst erbij.
\end{steps}
\end{recipe}
