...
\begin{ingredients}
  ...
  \ing{7 g}{droge gist}
  \ing{10 g}{zout}
  \ing{2 el}{extra vierge olijfolie (voor het deeg)}
  \ing{3–4 el}{extra vierge olijfolie (voor bovenop en de bakvorm)}
  \ingb{grof zeezout}
...
\begin{steps}
  \item Laat het deeg in de vorm nog 30–45 minuten rijzen.
\end{steps}
