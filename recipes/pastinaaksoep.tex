...
\kicker[Voorgerecht,Vegetarisch,Nederlands,Kerst]{Voorgerecht · vegetarisch · Nederlands · kerst}
...
\marginimage{images/pastinaaksoep-ingredienten}
...
\begin{ingredients}
  ...
  \ing{500 g}{vastkokende aardappels}\index[register]{Aardappelen}
  \ing{2}{knoflookteentjes}
  \ing{1 bosje}{lente-ui}
  \ing{2 el}{olijfolie}
  \ing{1 liter}{groentebouillon}
...
\end{steps}
\heroimagefade{images/pastinaaksoep}
\end{recipe}
