...
\kicker{Voorgerecht · hapje}
\index[register]{Mini-aardappelquiches}
\index[register]{Aardappelen}
\index[register]{Spek}
\index[register]{Parmigiano Reggiano}

\heroplaceholder{handgetekende illustratie van mini-quiches op een bordje}
\meta{40 minuten \dvd 12 stuks \dvd Kerst}
...
\ingredientsketch{mini-quiche}
\begin{steps}
  \item Verwarm de oven voor op 200\,°C. Vet een muffinvorm met 12 holtes in.
  ...
  \item Bak het spek in een droge koekenpan in 4--6 minuten krokant. Klop de slagroom,
        de geraspte kaas en de eieren samen met een garde.
  \item Verdeel het spek en de bosui over de aardappelbakjes. Schenk het
