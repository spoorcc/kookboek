...
\begin{ingredients}
  ...
  \ing{2 blikken (800\,g)}{gepelde tomaten, geplet}\index[register]{Tomaat}
...
\begin{steps}
  ...
  \item Verdeel over borden. Geef eventueel nog een scheutje olijfolie erbij.
        Wat plakjes komkommer of een \hyperref[recipe:groene-salade]{groene salade}
        erbij werkt goed als fris contrast.
\end{steps}
\heroimagefade[fadewidth=2.5cm]{images/pasta-amatriciana}
\end{recipe}
