...
\kicker{Bakken · kindertraktatie}
\index[register]{Drollenkoekjes}
\index[register]{Cacao}

\meta{1 uur koelen + 20 minuten bakken \dvd 12 stuks}

\lettrine{C}{hocoladekoekjes} in de vorm van een drol, als kindertraktatie. Ze
zijn niet moeilijk te maken en gaan er altijd in bij kinderen. Het deeg moet wel
minstens een uur rusten in de koelkast.

\blockrule{Ingrediënten}
\begin{ingredients}
  \ing{200 g}{ongezouten roomboter, kamertemperatuur}
  \ing{150 g}{donkere basterdsuiker}
...
\begin{steps}
  ...
  \item Verwarm de oven voor op 175\,°C. Verdeel het deeg in 12 gelijke stukken.
