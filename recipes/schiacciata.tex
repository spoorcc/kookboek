...
platgedrukt, en dat is ook precies waar het verschil zit: het deeg heeft een
lagere hydratatie en een kortere rijstijd dan focaccia (zie
blz.~\pageref{recipe:focaccia}), en wordt na het rijzen platgedrukt in plaats
van uitgerekt in een bakvorm. Daardoor wordt schiacciata compacter en
knapperiger, terwijl focaccia dikker en luchtiger blijft. Dat maakt
schiacciata juist weer makkelijk om horizontaal open te snijden en te
beleggen met vleeswaren en kaas.
...
\begin{steps}
  ...
  \item Bestrijk de schiacciata direct na het uit de oven halen heel licht
        met olijfolie.
  \item Laat daarna kort afkoelen op een rooster.
\end{steps}
