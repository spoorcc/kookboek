\begin{recipe}{Kibbeling, aardappelkroketjes en sla}
\kicker[Hoofdgerecht,Vis,Nederlands]{Hoofdgerecht · vis · Nederlands}
\index[register]{Kibbeling, aardappelkroketjes en sla}
\index[register]{Kibbeling}
\index[register]{Aardappelkroketjes}
\index[register]{IJsbergsla}

\meta{20 minuten \dvd Oven volgens verpakking}
\marginimage{images/kibbeling-kroketjes-sla}
...
\begin{ingredients}
  ...
  \ingb{dille (uit potje)}
\end{ingredients}

\blockrule{Bereiding}
\tip{Koop de kibbeling gezinsbucket XL vers van het Visgilde. }
\begin{steps}
  ...
  \item Was ondertussen de tomaat en de komkommer. Snijd ze samen met de
        ijsbergsla en doe ze in een ruime schaal. Voeg de slapitjes toe. Meng
        de olijfolie met de balsamicoazijn, peper, zout en dille tot een
        dressing en schep die door de sla.
  \item Serveer de kibbeling en kroketjes met de sla, remouladesaus en augurken
        of zilveruitjes ernaast.
\end{steps}
\end{recipe}
