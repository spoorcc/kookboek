...
\begin{steps}
  ...
  \item Haal uit de pan, laat 2-3 minuten rusten en verwijder het bakpapier. Snij de kip in plakken of serveer heel. Lekker met salade, groenten en aardappelen, bijvoorbeeld zoals in aardappel-groente-vlees (p.~\pageref{recipe:aardappel-groente-vlees}).
\end{steps}
\end{recipe}
