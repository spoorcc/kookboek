...
\lettrine{E}{en} snelle kipfilet met een krokant kaasmanteltje, gearomatiseerd met knoflook en rozemarijn. Het bakpapier houdt alles sappig en de bereiding is kinderspeelgoed.

\blockrule{Ingrediënten}
\begin{ingredients}
  \ing{2}{kipfilets (150-200 g per stuk)}
  \ing{4-6 el}{geraspte Parmezaanse kaas}
  \ing{2-3 teentjes}{knoflook, fijngehakt (of 1½ tl knoflookpoeder)}
  \ing{1½-2 tl}{gedroogde rozemarijn (of 1 el verse, fijngehakt)}
  \ing{1-2 tl}{olijfolie}
