...
\begin{steps}
  \item Houd de groentebouillon op een laag vuur warm; je voegt hem straks lepel
        voor lepel toe. Verwarm ondertussen de oven voor op 200\,°C (boven- en
        onderwarmte), zodat hij op temperatuur is wanneer de tomaatjes de oven
        in gaan.
  ...
  \item Rooster ondertussen de trostomaatjes in de oven tot ze zacht en zoet
        zijn.
  \item Roer van het vuur af de boter en Parmezaan erdoor. Laat de risotto een
        paar minuten rusten: dat is het moment waarop hij pas echt romig en
        glanzend wordt.
