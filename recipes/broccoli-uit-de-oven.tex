...
gesmolten is. Lekker naast aardappelen, groente of vlees.
...
gesmolten kaas.}
\begin{steps}
  \item Verwarm de oven voor op 200\,°C (boven- en onderwarmte). Was de
        broccoli en verdeel in roosjes.
  \item Kook de broccoliroosjes 5 tot 6 minuten in ruim water met zout tot
        ze beetgaar zijn. Giet af en laat goed uitstomen (zie tip).
  \item Verdeel de broccoli over een ovenschaal (ca.\ 26\,×\,18\,×\,7 cm),
        strooi de kaas en peper erover en bak 10 tot 15 minuten tot de kaas
        gesmolten is en lichtbruine plekken heeft.
\end{steps}

\heroimagefade{images/broccoli-uit-de-oven-hero}
\end{recipe}
