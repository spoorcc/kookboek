...
\lettrine{S}{aucijzenbroodjes} zijn een klassieke snack of traktatie, en
passen goed bij de lunch of als tussendoortje in de middag. Met een eigen
kruidenmengsel smaken ze merkbaar beter dan de versie uit de diepvries, en
zes stuks zijn zo klaar.
...
\begin{steps}
  ...
  \item Meng het zout, paprikapoeder, zwarte peper, uienpoeder, knoflookpoeder,
        nootmuskaat en korianderpoeder in een kommetje tot de gehaktkruiden.
  \item Splits het ei: tik de schaal in tweeën en schenk het eigeel heen en
        ...
        de schaal. Doe het eigeel in een apart kommetje en klop het los; dit
        is voor het bestrijken van de broodjes. Klop het eiwit los en voeg
        dit samen met de gehaktkruiden en het paneermeel bij het gehakt.
  \item Kneed het vleesmengsel goed door tot alles gelijkmatig verdeeld is.
  \item Verdeel het gehakt in 6 gelijke bollen van ongeveer 55\,g en leg elke
        bol in een rol op de helft van een plakje bladerdeeg.
  \item Bestrijk de vrije rand van het deeg dun met het achtergehouden eigeel
        en vouw het deeg dubbel over het vlees, zodat de natte rand op de
  ...
  \item Leg de broodjes met de naad naar onderen op een met bakpapier beklede
        bakplaat en bestrijk de bovenkant met het achtergehouden eigeel.
