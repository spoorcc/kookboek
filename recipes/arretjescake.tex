...
\kicker[Dessert,Zoet,Nederlands,Kerst]{Dessert · zoet · Nederlands · kerst}
...
\marginimage{images/arretjescake-ingredienten}
\lettrine{A}{rretjescake} heb ik een keer met kerst gemaakt als nagerecht. Het
is een ouderwetse chocoladecake zonder ei, gemaakt van gebroken koekjes in een
smeuïge chocolademassa. Er komt geen oven aan te pas. Smelt de chocolade au
bain-marie en laat de cake daarna opstijven in de koelkast.

\blockrule{Ingrediënten}
\begin{ingredients}
  \ing{250 g}{ongezouten roomboter of margarine}\index[register]{Boter}
...
\heroimagefade{images/arretjescake}
\end{recipe}
