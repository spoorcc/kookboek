...
\marginimage{images/blinis-vier-toppings-ingredienten}
...
anders snel zacht. Heb je tijd over? Maak de pesto voor de rosbiefvariant
dan zelf (p.~\pageref{recipe:pesto-genovese}).}
\begin{steps}
...
\heroimagefade{images/blinis-vier-toppings}
\end{recipe}
