...
\begin{ingredients}
  \ing{100 g}{boter, op kamertemperatuur}
  \ing{100 g}{witte basterdsuiker}
  \ing{2}{eieren}
  \ing{1/2 tl}{vanille-extract}
  \ing{100 g}{patentbloem}
...
\blockrule{Glazuur}
\begin{ingredients}
  \ing{60 g}{frambozen (diepvries)}\index[register]{Frambozen}
  \ing{120 g}{poedersuiker}
\end{ingredients}
...
\begin{steps}
  ...
  \item Laat de koekjes 5 minuten rusten, haal ze dan uit de vorm en leg ze
        ondersteboven op een rekje. Laat volledig afkoelen.
