...
\meta{20 minuten \dvd Voor 5 personen}
...
\begin{ingredients}
  \ing{1 bucket XL}{kibbeling (Visgilde)}\index[register]{Kibbeling}
  \ingb{aardappelkroketjes uit de oven}\index[register]{Aardappelkroketjes}
  \ing{—}{ijsbergsla}\index[register]{IJsbergsla}
  \ing{1}{tomaat}
  \ing{1}{komkommer}
...
\blockrule{Bereiding}
\tip{Lekker met remouladesaus en wat losse augurken of zilveruitjes erbij.}
\begin{steps}
