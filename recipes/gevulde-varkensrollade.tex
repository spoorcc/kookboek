...
\begin{ingredients}
  ...
  \ing{1 bakje}{roomkaas, zacht}\index[register]{Roomkaas}
  \ing{1 pot}{geroosterde rode paprika, uitgelekt}\index[register]{Paprika}
  \ingb{spek, ongebakken}
  \ingb{plakken koude prosciutto}
  \ing{1 bakje}{verse pesto}\index[register]{Pesto}
  \ing{1 klein zakje}{bladspinazie}
  \ingb{olijfolie}
