...
\meta{30 minuten + 75 minuten oven \dvd Voor 6 personen \dvd Italiaans}
...
\begin{ingredients}
  ...
  \ing{450 g}{roomkaas (2 pakken), zacht}\index[register]{Roomkaas}
  \ing{1 pot}{geroosterde rode paprika, uitgelekt}\index[register]{Paprika}
  \ingb{spek of prosciutto, gebakken en verkruimeld}
  \ing{3--4 el}{verse groene pesto}\index[register]{Pesto}
  \ingb{bladspinazie}
  \ingb{olijfolie}
  \ingb{paprikapoeder, zout, peper}
\end{ingredients}
...
\begin{steps}
  \item Leg het vlees plat op een snijplank. Snijd het open als een boek
        ...
        dikte.
  \item Verdeel de spinazie, geroosterde paprika, pesto, spek en roomkaas
        gelijkmatig over het vlees. Breng op smaak met zout en peper.
  ...
  \item Verwarm de oven voor op 175\,°C. Leg de rollade in een braadpan en bak
