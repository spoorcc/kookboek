...
\meta{Rijzen ca. 75 minuten \dvd 1 brood \dvd Oven 220\,°C}

\marginimage{images/brood-ingredienten}
...
\begin{ingredients}
  ...
  \ing{280 ml}{water (56\%)}
  \ing{15 g}{ongezouten roomboter (3\%)}
  \ing{8 g}{zout (1,6\%)}
  \ing{8 g}{droge gist}
...
\begin{steps}
  ...
  \item Snij vlak voor het de oven in gaat een paar keer in de bovenkant:
        zo kan het brood tijdens het bakken beter rijzen.
