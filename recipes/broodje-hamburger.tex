...
\meta{30 minuten \dvd Oven grillstand}

\marginimage{images/broodje-hamburger-ingredienten}
...
samenstellen. Coleslaw (p.~\pageref{recipe:coleslaw}) is een lekker fris
bijgerecht erbij.
...
\begin{ingredients}
  ...
  \ing{1}{komkommer, gewassen en in plakjes}
  \ing{1}{paprika, gewassen en in reepjes}
  \ing{5}{plakjes kaas}
  \ingb{mayonaise}
  \ingb{tomatenketchup}
  \ingb{burgersaus}
...
\begin{steps}
  \item Snij de ui in dunne ringen.
  \item Verhit een klontje boter met een scheutje water in een koekenpan op laag
        vuur, voeg de ui met een snufje zout toe en laat hem langzaam
        karamelliseren. Het snufje zout trekt vast vocht uit de ui, het lage vuur
        en het scheutje water voorkomen dat hij verbrandt voor hij zoet en zacht
        is.
  \item Verdeel de sla in blaadjes. Was de tomaat en snij hem in plakken.
  \item Kruid de hamburgers, als ze niet al gekruid zijn, rondom stevig met zout en
        peper.
  \item Verhit bakboter in een tweede koekenpan op middelhoog vuur en bak de
        hamburgers, ongeveer 10 minuten. Check de verpakking voor de precieze tijd,
        dit verschilt per merk. Druk de burgers niet aan met de spatel: elk drukje
        perst het sap eruit dat in het broodje had moeten zitten.
