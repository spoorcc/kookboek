...
\begin{steps}
  \item Snij de ui in dunne ringen. Verhit een klontje boter met een scheutje water in
        een koekenpan op laag vuur, voeg de ui met een snufje zout toe en laat hem
        langzaam karamelliseren. Het snufje zout trekt vast vocht uit de ui, het lage
        vuur en het scheutje water voorkomen dat hij verbrandt voor hij zoet en zacht
        is.
  ...
  \item Kruid de hamburgers, als ze niet al gekruid zijn, rondom stevig met zout en
        peper. Verhit bakboter in een tweede koekenpan op middelhoog vuur en bak de
