...
\marginimage{images/tomaten-pestorisotto-ingredienten}
...
\begin{ingredients}
  ...
  \ing{170 g}{risottorijst}\index[register]{Risotto}
...
de risotto pas écht romig. Heb je tijd over? Maak de pesto dan zelf
...
\begin{steps}
  ...
  \item Fruit de ui en knoflook zachtjes in olijfolie in een hapjespan tot de ui
        glazig is. Bak de risottorijst kort mee tot de korrels glazig zien.
...
\heroimagefade{images/tomaten-pestorisotto-hero}
\end{recipe}
