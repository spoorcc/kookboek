...
\index[register]{Melk}
\index[register]{Citroensap}

\meta{45 minuten + uitlekken \dvd Circa 500 g ricotta}

\lettrine{V}{erse} ricotta maken kost weinig meer dan melk, een scheut citroensap
en wat geduld. Zodra de melk warm genoeg is en het zuur erbij gaat, doet de
ricotta het grootste deel van het werk zelf: ze klontert vanzelf samen terwijl
ze uitlekt.

\blockrule{Ingrediënten}
\begin{ingredients}
  \ing{2 liter}{volle melk (geen UHT/langhoudbare melk)}\index[register]{Melk}
  \ing{250 ml}{slagroom, minimaal 35\% vet (optioneel, voor extra romigheid)}
  \ing{60 ml}{vers citroensap of witte natuurazijn}\index[register]{Citroensap}
  \ing{6 g}{fijn zeezout (ongeveer 1 afgestreken theelepel)}
\end{ingredients}
...
best. Zodra het zuur in de pan zit, niet meer roeren, anders spoelen de
vlokken door de doek en wordt de ricotta korrelig. Bewaar de afgeschepte wei:
die is prima te gebruiken in brooddeeg, soep of een smoothie.}
\begin{steps}
  \item Giet de melk (en eventueel de slagroom) in een pan met dikke bodem en
        ...
        keukenthermometer in de vloeistof, tot precies 85\,°C. Roer
        regelmatig over de bodem om aanbranden te voorkomen.
  \item Haal de pan van het vuur zodra de thermometer 85\,°C aangeeft. Giet
        het citroensap of de azijn erbij en roer één keer heel rustig door.
        Doe de deksel op de pan en laat 15 minuten ongestoord staan: de melk
        splitst in witte vlokken en een geelgroene vloeistof (wei).
