...
\marginimage{images/bloemkoolquiche-ingredienten}
...
\begin{steps}
  ...
  \item Snipper de ui. Bak de spekreepjes in een koekenpan op middelhoog vuur
        tot ze beginnen te kleuren, voeg de ui toe en bak tot de ui glazig is.
  \item Voeg de bloemkool toe en bak 2 tot 3 minuten mee zodat de smaak van
        ui en spek over de bloemkool trekt. Haal van het vuur en breng op
        smaak met peper.
  ...
  \item Rol het deeg uit tot de grootte van de springvorm plus de rand. Vet de
        ...
        vorm en laat het een klein beetje over de rand uitsteken. Gebruik je
        ...
        voorkomt dat het deeg tijdens het voorbakken opbolt.
  \item Voorbakken: bak de bodem 15 minuten. Gebruik je bladerdeeg? Bak dan in
...
\heroimagefade{images/bloemkoolquiche}
\end{recipe}
