...
\kicker{Dessert · Nederlands}
\index[register]{Eierkoeken}
\index[register]{Eieren}
\index[register]{Citroen}

\heroplaceholder{handgetekende illustratie van een schaal eierkoeken}
\meta{25 minuten \dvd 6--8 stuks \dvd Nederlands}

\lettrine{E}{ierkoeken} zijn een klassiek Nederlands koekje dat je vroeger bij de bakker
vond en dat eigenlijk heel simpel zelf te maken is. Het citroen geeft ze een frisse smaak,
...
\ingredientsketch{citroen}
\begin{steps}
  \item Verwarm de oven voor op 200 graden en zet de bakplaat alvast in de oven.
