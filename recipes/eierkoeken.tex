...
\begin{ingredients}
  \ing{120 g}{patentbloem}
  \ing{100 g}{suiker (ca.\ 83\%)}
  \ing{2}{eieren, op kamertemperatuur}\index[register]{Eieren}
  \ing{8 g}{bakpoeder (½ zakje)}
  \ingb{rasp van 1 gewassen citroen}\index[register]{Citroen}
...
\begin{steps}
  ...
  \item Klop de eieren met de suiker minstens 5 minuten goed luchtig, tot de massa
        echt bleek en dik is. Til de garde op: het beslag moet er dik en traag
        vanaf lopen en een paar seconden een duidelijk spoor achterlaten op het
        beslag in de kom voor het wegzakt (dit heet ook wel een lint, of en
        ruban). Er zit weinig bakpoeder in dit beslag, dus dat
        luchtig geklopte ei is hier de hele structuur.
