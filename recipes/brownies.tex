...
\marginimage{images/brownies}
\lettrine{E}{en} simpel basisrecept voor smeuïge, fudgy brownies met een
dunne, krokante bovenkant. Gebruik pure chocolade met minstens 60\% cacao
...
\begin{ingredients}
  ...
  \ing{150 g}{ongezouten roomboter (150\%)}
...
\blockrule{Bereiding}
\tip{Wil je extra textuur? Spatel 75 g grof gehakte noten of extra
chocoladestukjes met de bloem door het beslag.}
\begin{steps}
  \item Verwarm de oven voor op 175\,°C (boven- en onderwarmte) en bekleed
        een vierkante bakvorm van ca.\ 20 × 20 cm met bakpapier.
  \item Hak de chocolade grof en smelt hem met de boter op laag vuur in een
        steelpannetje, of au bain-marie, tot een glad mengsel. Laat iets afkoelen.
  \item Klop de eieren en suiker met een garde of handmixer 2 tot 3 minuten
        schuimig en licht van kleur.
  ...
  \item Steek aan het einde van de baktijd een satéprikker in het midden: er mogen
        nog wat vochtige kruimels aan blijven plakken, komt hij er helemaal droog uit
        dan is de brownie al te ver doorgebakken. Laat volledig afkoelen in de vorm
        voor je in vierkantjes snijdt.
\end{steps}
\end{recipe}
