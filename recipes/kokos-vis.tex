...
\lettrine{E}{en} snel wokgerecht met witvis in een romige currysaus. De vis
gaat maar heel kort in de pan, de groente erna, en de currypasta en
kokosmelk maken de saus af. Ondertussen kook je de rijst.

\blockrule{Ingrediënten}
\begin{ingredients}
  \ing{300 g}{pangasiusfilet of witvis (diepvries), in blokjes}
  ...
  \ingb{rood pepertje, fijngesneden (weglaten voor kinderen)}
...
\begin{steps}
  ...
  \item Snijd de vis in blokjes en het pepertje fijn.
  ...
  \item Voeg de currypasta en het pepertje toe en bak een minuutje mee.
