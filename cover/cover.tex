...
%  interior file. All the constants below (trim, wrap area, safety
%  margin, and the spine width below) were read directly off one such
%  template, q6qdvpe-cover-template.pdf, regenerated for the interior's
%  current 176-page count (trim and wrap area are unchanged from the
%  164-page version — only spine width moved, to 17.48mm).
%
...
\newcommand{\interiorpagecount}{176} % <-- UPDATE to match the built interior PDF
\newlength\spinew
\setlength\spinew{17.48mm} % <-- Lulu's own spine width for 176 pages, per the
% regenerated q6qdvpe-cover-template.pdf (see note above)
