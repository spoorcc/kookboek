...
\begin{tikzpicture}[remember picture, overlay]
  ...
  % minimum. Inset it at a smaller size instead, comfortably under the
  % ~131x166mm ceiling that keeps the source photo at or above 300dpi.
  \node[inner sep=0, outer sep=0, anchor=south] at
      ([shift={(\frontx+0.5\panelw,3.75cm)}]current page.south west) {%
    \includegraphics[height=11.5cm]{images/pasta}};
