...
% Measured here in normal document flow (not inside the tikzpicture
% below, where fontspec's \addfontfeatures — used by \labelcaps —
% mysteriously resolves to nullfont) so the front cover's footer plate
% can be sized to this text's actual width instead of a guess.
\newlength\footertextw
\settowidth{\footertextw}{\footnotesize\labelcaps{6.0}{Bereid met liefde \textperiodcentered{} Anno MMXXVI}}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \def\frontgrid{aardappel-groente-vlees/27.718mm/17.770mm,arretjescake/27.718mm/18.417mm,asperge-lasagne/27.718mm/15.337mm,blinis-vier-toppings/27.718mm/14.721mm,bloemkoolpasta-hero/27.542mm/24.104mm,bloemkoolquiche/27.718mm/17.185mm,bobotie/27.718mm/12.812mm,broccoli-uit-de-oven-hero/27.718mm/17.308mm,broccolipasta-witvis-olijven-rode-ui/27.718mm/19.187mm,brood/27.718mm/14.999mm,broodje-hamburger/27.718mm/14.383mm,broodje-knakworst/27.718mm/16.354mm,burritos/27.718mm/15.799mm,chili-con-carne/27.718mm/20.934mm,ciabatta/27.718mm/18.509mm,couscous/27.718mm/21.281mm,doner-kebab/27.718mm/17.979mm,fajitas/26.258mm/24.104mm,falafel/27.718mm/15.584mm,flammkuchen/27.718mm/15.676mm,focaccia/27.718mm/16.138mm,gegrilde-courgette/27.718mm/21.946mm,geroerbakte-spruitjes-hero/27.718mm/21.090mm,gevulde-paprika-hero/27.718mm/18.602mm,gnocchi/27.718mm/15.522mm,gnocchi-sorrentina/27.718mm/15.368mm,gnocchi-zongedroogde-tomaten-hero/27.718mm/18.119mm,groene-salade/27.718mm/22.000mm,hamburgerbolletjes/27.718mm/17.370mm,horiatiki/26.174mm/24.104mm,involtini-di-maiale-hero/27.718mm/17.401mm,jambalaya/27.718mm/18.411mm,kalkoen-in-spek/27.718mm/16.877mm,kipfilet-parmezaan-knoflook/27.718mm/23.399mm,kippensoep-simpel/27.718mm/20.851mm,kofta/27.718mm/17.955mm,kokos-vis/27.718mm/21.054mm,lasagne-simpel/27.718mm/18.417mm,mac-n-cheese/27.718mm/18.201mm,meringues/27.718mm/18.848mm}
  ...
  \newlength\frontch \setlength\frontch{\dimexpr\gridh/8\relax} % 8 rows -> 40 tiles
  ...
  % Corner ornaments instead of a full frame line: a short two-arm
  % bracket plus the book's own ♦ motif (already used on the spine, the
  % back cover and the front title above) at each of the box's 4 corners.
  % Reads as a light, open frame — warmer than a bare rule, without
  % boxing the panel in with a heavy continuous line.
  \newlength\cornerarm \setlength\cornerarm{9mm}
  % \cornerornament{corner x}{corner y}{arm-end x}{arm-end y}
  \newcommand{\cornerornament}[4]{%
    \draw[ink, line width=0.7pt]
      ([shift={(#1,#2)}]current page.south west) --
      ([shift={(#3,#2)}]current page.south west);
    \draw[ink, line width=0.7pt]
      ([shift={(#1,#2)}]current page.south west) --
      ([shift={(#1,#4)}]current page.south west);
  ...
  % Footer plate sized to the text's own measured width plus a small
  % padding, not the full grid width — the earlier full-width plate hid
  % 4-5 photos in that row for one short line of text; a fitted plate
  % leaves most of them showing.
  \fill[paper, opacity=0.9, rounded corners=2pt]
    ([shift={(\dimexpr\frontboxcenterx-0.5\footertextw-6mm\relax,\gridbottom)}]current page.south west) rectangle
    ([shift={(\dimexpr\frontboxcenterx+0.5\footertextw+6mm\relax,\dimexpr\gridtop-7\frontch\relax)}]current page.south west);
  \node[anchor=center, align=center] at
      ([shift={(\frontboxcenterx,\dimexpr\gridtop-7.5\frontch\relax)}]current page.south west) {%
