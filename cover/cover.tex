...
\begin{tikzpicture}[remember picture, overlay]
  ...
  % peeking out above or below the text. Spans the grid's own width
  % (\frontgridleft/\frontgridright), matching the mat framing it.
  \fill[paper, opacity=0.9, rounded corners=2pt]
    ([shift={(\frontgridleft,\dimexpr\gridtop-4\frontch\relax)}]current page.south west) rectangle
    ([shift={(\frontgridright,\dimexpr\gridtop-1\frontch\relax)}]current page.south west);
  \fill[paper, opacity=0.9, rounded corners=2pt]
    ([shift={(\frontgridleft,\gridbottom)}]current page.south west) rectangle
    ([shift={(\frontgridright,\dimexpr\gridtop-7\frontch\relax)}]current page.south west);
  ...
  \node[anchor=center, align=center, text width=\boxw] at
      ([shift={(\frontboxcenterx,\dimexpr\gridtop-2.5\frontch\relax)}]current page.south west) {%
  ...
  % Spans the grid's own width, matching the mat framing it.
  \fill[paper, opacity=0.9, rounded corners=2pt]
