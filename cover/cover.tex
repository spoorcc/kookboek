...
\begin{tikzpicture}[remember picture, overlay]
  ...
  % rows: the quote below was expanded with a bit more of the voorwoord's
  % own context (who it's for, that nothing here is invented, that this
  % is the first time it's all been written down), so the tight 2-row
  % plate from before no longer has room for it without crowding.
  \fill[paper, opacity=0.9, rounded corners=2pt]
